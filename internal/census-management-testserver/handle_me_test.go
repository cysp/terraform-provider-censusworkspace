package censusmanagementtestserver_test
...
import (
	...
	cmts "github.com/cysp/terraform-provider-census/internal/census-management-testserver"
...
func TestHandleMeNotFound(t *testing.T) {
	...
	ts := cmts.NewCensusManagementTestServer()
