...
func (r *sourceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	responseModel, responseModelDiags := NewSourceResourceModelFromResponse(ctx, getSourceResponse.Response.Data)
	resp.Diagnostics.Append(responseModelDiags...)

	responseModel.Credentials = plan.Credentials
...
func (r *sourceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	responseModel.Credentials = state.Credentials
...
func (r *sourceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	responseModel, responseModelDiags := NewSourceResourceModelFromResponse(ctx, updateSourceResponse.Response.Data)
	resp.Diagnostics.Append(responseModelDiags...)
