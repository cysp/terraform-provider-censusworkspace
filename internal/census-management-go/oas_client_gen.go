...
type Invoker interface {
	...
	//
	// POST /api/v1/sources
	CreateSource(ctx context.Context, request *CreateSourceData) (*CreateSource2XXStatusCode, error)
	// DeleteSource invokes deleteSource operation.
	//
	// Delete source.
	//
	// DELETE /api/v1/sources/{source_id}
	DeleteSource(ctx context.Context, params DeleteSourceParams) (*StatusStatusCode, error)
	...
	UpdateSource(ctx context.Context, request *UpdateSourceData, params UpdateSourceParams) (*UpdateSource2XXStatusCode, error)
}
...
//
// POST /api/v1/sources
func (c *Client) CreateSource(ctx context.Context, request *CreateSourceData) (*CreateSource2XXStatusCode, error) {
	res, err := c.sendCreateSource(ctx, request)
	return res, err
}

func (c *Client) sendCreateSource(ctx context.Context, request *CreateSourceData) (res *CreateSource2XXStatusCode, err error) {
...
//
// DELETE /api/v1/sources/{source_id}
func (c *Client) DeleteSource(ctx context.Context, params DeleteSourceParams) (*StatusStatusCode, error) {
	res, err := c.sendDeleteSource(ctx, params)
	return res, err
}

func (c *Client) sendDeleteSource(ctx context.Context, params DeleteSourceParams) (res *StatusStatusCode, err error) {
...
//
// PUT /api/v1/sources/{source_id}
func (c *Client) UpdateSource(ctx context.Context, request *UpdateSourceData, params UpdateSourceParams) (*UpdateSource2XXStatusCode, error) {
	res, err := c.sendUpdateSource(ctx, request, params)
	return res, err
}

func (c *Client) sendUpdateSource(ctx context.Context, request *UpdateSourceData, params UpdateSourceParams) (res *UpdateSource2XXStatusCode, err error) {
