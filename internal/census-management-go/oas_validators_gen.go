...
func (s *SourceModelData) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s SourceModelDataType) Validate() error {
	switch s {
	case "model":
		return nil
	default:
...
func (s *SourceModelResponse) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *SourceModelResponseStatusCode) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
