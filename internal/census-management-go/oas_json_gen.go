...
func (s *CreateSource2XX) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
func (s *CreateSource2XX) encodeFields(e *jx.Encoder) {
	{
		if s.Status.Set {
			e.FieldStart("status")
			s.Status.Encode(e)
...
var jsonFieldsNameOfCreateSource2XX = [2]string{
	0: "status",
	1: "data",
}

// Decode decodes CreateSource2XX from json.
func (s *CreateSource2XX) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateSource2XX to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CreateSource2XX")
	}
...
func (s *CreateSource2XX) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
func (s *CreateSource2XX) UnmarshalJSON(data []byte) error {
...
var jsonFieldsNameOfSource = [8]string{
	0: "id",
	1: "name",
	2: "label",
	3: "type",
...
// Encode implements json.Marshaler.
func (s *UpdateSource2XX) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *UpdateSource2XX) encodeFields(e *jx.Encoder) {
	{
		if s.Status.Set {
			e.FieldStart("status")
			s.Status.Encode(e)
...
var jsonFieldsNameOfUpdateSource2XX = [2]string{
	0: "status",
	1: "data",
}

// Decode decodes UpdateSource2XX from json.
func (s *UpdateSource2XX) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UpdateSource2XX to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode UpdateSource2XX")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *UpdateSource2XX) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *UpdateSource2XX) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
