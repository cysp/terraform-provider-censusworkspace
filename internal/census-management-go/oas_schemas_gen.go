...
func (s *CreateSourceBodyConnection) GetLabel() NilString {
	return s.Label
}
...
func (s *CreateSourceBodyConnection) SetLabel(val NilString) {
	s.Label = val
}
...
// GetLabel returns the value of Label.
func (s *UpdateSourceBodyConnection) GetLabel() NilString {
	return s.Label
}
...
// SetLabel sets the value of Label.
func (s *UpdateSourceBodyConnection) SetLabel(val NilString) {
	s.Label = val
}
